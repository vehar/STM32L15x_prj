...
#define CPAL_I2C_TIMEOUT_SB             0        
#define CPAL_I2C_TIMEOUT_ADDR           0
#define CPAL_I2C_TIMEOUT_ADD10          0
#define CPAL_I2C_TIMEOUT_TXE            0
#define CPAL_I2C_TIMEOUT_RXNE           0
#define CPAL_I2C_TIMEOUT_BTF            0
#define CPAL_I2C_TIMEOUT_BUSY           0


/* DO NOT MODIFY THESE VALUES ---------------------------------------------------------*/
#define CPAL_I2C_TIMEOUT_DEFAULT        ((uint32_t)0xFFFFFFFF)
#define CPAL_I2C_TIMEOUT_MIN            ((uint32_t)0x00000010)
